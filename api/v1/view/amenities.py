#!/usr/bin/python3
""" objects that handles all routes for RestFul API actions on Amenities"""
...
def get_amenity(amenity_id):
    ...
    Returns:
        Dict: json for the required id passed
    """
...
def delete_amenity(amenity_id):
    ...
    Returns:
        Dict: json returning the detail for deleting the amenties
    """
    amenity = storage.get(Amenity, amenity_id)
...
def post_amenity():
    ...
    Returns:
        Dict: json returning the detail for adding the amenties
    """
