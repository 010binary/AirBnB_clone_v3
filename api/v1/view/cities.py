#!/usr/bin/python3
""" objects that handles all routes for RestFul API actions on cities """
...
def get_cities(state_id):
    ...
    Args:
        state_id (int): state of relation to the city

    Returns:
        Dict: json returning the detail for all the city
    """
    list_cities = []
...
def get_city(city_id):
    ...
    Args:
        city_id (int): id for the specific city

    Returns:
        Dict: json returning the detail for required a city
    """
...
def delete_city(city_id):
    ...
    Returns:
        Dict: json returning the detail for deleting a city
    """
    city = storage.get(City, city_id)
...
def post_city(state_id):
    ...
    Returns:
        Dict: json returning the detail for adding a city
    """
    state = storage.get(State, state_id)
    if not state:
        abort(404)
...
def put_city(city_id):
    ...
    Returns:
        Dict: json returning the detail for updating the city
    """
    city = storage.get(City, city_id)
    if not city:
        abort(404)
